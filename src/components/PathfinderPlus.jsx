...
export default function PathfinderPlus(props){
    ...
    <motion.div className="container" initial={{y: -200, opacity: 0, transform: "scale(0)"}} animate={{y: 0, opacity: 1, transform: "scale(1)"}} transition={{default: {duration: 1}}}>
            <Card className="p-5 border border-dark bg-dark text-white text-center" id="card" style={{'overflowY': 'scroll', 'maxHeight': '90%', 'marginTop': '10%'}}>
                <Box>
        ...
        <motion.div className="container bg-transparent h-75" initial={{y: -200, opacity: 0, transform: "scale(0)"}} animate={{y: 0, opacity: 1, transform: "scale(1)"}} transition={{default: {duration: 1}}}>
                <Card className="text-center bg-dark text-white h-100 p-5 border border-dark" id="card" style={{'overflowY': 'scroll','marginTop': '5%'}}>
