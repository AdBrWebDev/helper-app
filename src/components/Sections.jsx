...
export default function Sections(props){
    ...
    return(<Grid data-aos="fade-up" data-aos-offset="400" className="my-5 py-2" container key={props.index}>
            <Grid data-aos="fade-right" data-aos-offset="430" item xs={12} sm={12} md={6} lg={6} xl={6}>
            ...
            <Grid data-aos="fade-left" data-aos-offset="430" item xs={12} sm={12} md={6} lg={6} xl={6}>
