...
export default function MainPage(){
    ...
    {img: 'skiForum.jpg', title: 'Fórum', text: "Potrebuješ pomôcť?"},
    {img: 'maps.png', title: 'Mapa', text: "So mnou sa nestratíš"},
    {img: 'skiingArticles.png', title: 'Články', text: "Spoznávaj nové miesta"},
    {img: 'forest.jpg', title: 'Príroda', text: "Pomôž zachrániť prírodu"},
    {img: 'skiingMain.jpg', title: 'Pathfinder plus', text:"Tu najdeš pomoc pri tvojich problémoch"}]
    ...
    return(<motion.div initial={{y: 200, opacity: 0, transform: "scale(0)"}} animate={{y: 0, opacity: 1, transform: "scale(1)"}} transition={{default: {duration: 1}}}><Box className="w-100 text-center">
        <Grid container className="mt-5">
            ...
            <img style={{'height': '500px', 'transformOrigin': ' bottom', 'transform': 'skewY(-3deg)'}} src="images/skiingMain.jpg" alt="" />
            </Grid>
